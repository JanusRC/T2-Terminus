/**
  ******************************************************************************
  * @file    stm32_eval_sdio_sd.c ##### MODIFIED FOR T2 ####
...
/** @addtogroup STM32_T2_SDIO_SD
  * @brief      This file provides all the SD Card driver firmware functions.
  * @{
  */

/** @defgroup STM32_T2_SDIO_SD_Private_Types
  * @{
  */
/**
  * @}
...
/** @defgroup STM32_T2_SDIO_SD_Private_Defines
  * @{
  */
/**
...
/** @defgroup STM32_T2_SDIO_SD_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM32_T2_SDIO_SD_Private_Variables
  * @{
  */
static uint32_t CardType =  SDIO_STD_CAPACITY_SD_CARD_V1_1;
static uint32_t CSD_Tab[4], CID_Tab[4], RCA = 0;
static uint8_t SDSTATUS_Tab[64]; // ENGR:CT Was 16
...
/** @defgroup STM32_T2_SDIO_SD_Private_Function_Prototypes
  * @{
  */
...
/** @defgroup STM32_T2_SDIO_SD_Private_Functions
  * @{
  */
...
SD_Error SD_WaitWriteOperation(void)
{
  ...
  while((SD_DMAEndOfTransferStatus() == RESET) && (TransferEnd == 0) && (TransferError == SD_OK));
	...
	// Ultra SD, DMA with TC with DCOUNT = 0x7C, FIFOCNT = 0x1E type results
	// Will also spuriously interrupt
		
  if (TransferError != SD_OK)
    return(TransferError);

	while(SDIO->DCOUNT); // Wait on FIFO clearing
...
SD_Error SD_ProcessIRQSrc(void)
{
  ...
  else
  {
	...
	if (SDIO_GetITStatus(SDIO_IT_DATAEND)) // ENGR:CT 27-Mar-2012
	{	
