// USED FOR SDIO-BASED SD CARDS - Edited for STM32F4 library use
/*
 * @author: ickle 
...
#include "ff.h"
#include "diskio_STM32F4.h"
#include "sdio_sdcard_STM32F4.h"
  ...
  )
{
  ...
  //SetDeviceMode isn't needed (for now), DMA mode is defined for use
...
{
  DRESULT res = RES_OK;
  uint32_t status = SD_TRANSFER_OK;
